...
export default function UpdatePassword() {
  ...
  return (
    <div className="flex min-h-[80vh] items-center justify-center bg-[#fafafa] px-4 py-12 sm:px-6 lg:px-8">
        ...
        {!isSuccess ? (
          ...
          <div className="text-center space-y-6">
            ...
            <div className="pt-2">
              <Link
                href="/login"
                className="block w-full py-2.5 bg-gray-900 text-white font-semibold text-sm text-center rounded-full transition-all duration-200 hover:bg-gray-800 shadow-sm"
              >
                Go to Log In
              </Link>
            </div>
