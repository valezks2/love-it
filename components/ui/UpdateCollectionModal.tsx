...
export default function UpdateModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-lg overflow-hidden rounded-3xl bg-white p-6 shadow-2xl border border-gray-100 z-10 flex flex-col gap-5 max-h-[90vh]">
        ...
        >
          <div className="space-y-1.5">
            ...
            <div
              ...
              className={`relative aspect-[21/9] w-full rounded-2xl overflow-hidden border flex flex-col items-center justify-center transition-all duration-200 cursor-pointer ${
                isDragging
              ...
              {bannerPreview ? (
                <div className="relative w-full h-full group">
                  ...
                  <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex items-center justify-center">
                    <span className="px-4 py-2 bg-white text-gray-700 text-xs font-semibold rounded-full shadow-sm hover:bg-gray-50 transition">
                      Change Banner
                    </span>
                  </div>
                </div>
          ...
          <div className="flex items-center justify-end gap-3 pt-3 border-t border-gray-100">
            <button
              ...
              onClick={onClose}
              disabled={isSaving}
              className="px-5 py-2.5 text-sm font-bold text-gray-500 hover:text-gray-700 hover:bg-gray-50 rounded-full transition-colors active:scale-95"
            >
              Cancel
            </button>
            <button
              type="submit"
              disabled={isSaving}
              className={`px-8 py-2.5 rounded-full text-sm font-bold text-white bg-[#b72c0f] shadow-sm hover:bg-[#96240c] transition-all active:scale-95 flex items-center justify-center gap-2 ${
